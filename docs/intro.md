...
**Docs-as-Code** platform for technical documentation.
...
- A small documentation structure under `docs/` with multiple pages
- Sidebar and table of contents navigation
...
- Use the **left sidebar** to navigate between `Intro`, `Getting Started`,
